        ...
        for prop_type in COMMON_ABSTRACT_TYPES_MAP:
            ...
            for prop_name in prop_names:
                prop_inds = np.asarray([
                    get_soma_inds(
                        f'attribute-{prop_name}',
                        f'{prop_name}{prop_value}_single_coding_appear',
                ...
                popu_coding_inds = np.asarray([
                    get_soma_inds(
                        f'attribute-{prop_name}',
                        f'{prop_name}{popu_coding_value}_popu_coding_appear',
        ...
        single_coding_inds = [
            get_soma_inds(
                ...
                ['neurons'][cortex['neuron_no']
                            [popu_coding_ind]]['name'].replace('popu_coding', 'single_coding'),
